# Projeto Integrador: Requisitos (Funcionais/Não Funcionais)
...
* **RNF06 – Boa performance:**
    O sistema e suas diferentes páginas devem carregar e salvar informações de maneira rápida.# .github
